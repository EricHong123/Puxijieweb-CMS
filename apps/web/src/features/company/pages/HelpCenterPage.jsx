  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content={`${getSiteOrigin()}/${locale}/help-center`} />
        <meta property="og:title" content={t(locale, 'helpCenterPage.title')} />
        <meta property="og:description" content={t(locale, 'helpCenterPage.heroDesc')} />
        <meta property="og:image" content={`${getSiteOrigin()}/og-default.jpg`} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={t(locale, 'helpCenterPage.title')} />
        <meta name="twitter:description" content={t(locale, 'helpCenterPage.heroDesc')} />
